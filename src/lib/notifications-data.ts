...
export const allNotifications: AppNotification[] = [
  ...
  /* ─────────── Jennifer Chen — org-admin-1 ─────────── */
  {
    ...
    body: 'A new FinalPlaybook chapter compiled for her. (You see only completion — never her answers.)',
    read: false,
  },
  {
    id: 'n-jc-2',
